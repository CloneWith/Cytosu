...
namespace osu.Game.Rulesets.Cytosu.Objects.Drawables
{
    internal partial class SkinnableLighting : SkinnableSprite
    {
        ...
        public void SetColourFrom(DrawableCytosuJudgement targetJudgement, JudgementResult? targetResult)
        {
        ...
        private void updateColour()
        {
            if (targetJudgement == null || targetResult == null)
                ...
                Colour = targetResult.IsHit ? targetJudgement.Colour : Color4.Transparent;
        }
    }
}
